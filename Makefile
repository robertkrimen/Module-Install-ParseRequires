# This Makefile is for the Module::Install::ParseRequires extension to perl.
#
...
#     ABSTRACT => q[A Module::Install extension that provides an alternate way to specify dependencies]
#     AUTHOR => q[Robert Krimen]
#     DIR => []
#     DISTNAME => q[Module-Install-ParseRequires]
#     NAME => q[Module::Install::ParseRequires]
#     NO_META => q[1]
#     PL_FILES => {  }
#     PREREQ_PM => { Test::More=>q[0], YAML::Tiny=>q[0], File::Spec=>q[0], ExtUtils::MakeMaker=>q[6.42], Module::Install=>q[0.85] }
#     VERSION => q[0.001]
#     dist => { PREOP=>q[$(PERL) -I. "-MModule::Install::Admin" -e "dist_preop(q($(DISTVNAME)))"] }
#     realclean => { FILES=>q[MYMETA.yml] }
#     test => { TESTS=>q[t/01-basic.t] }
...
NAME_SYM = Module_Install_ParseRequires
VERSION = 0.001
...
MAKEMAKER   = /home/rob/perl5/lib/perl5/ExtUtils/MakeMaker.pm
MM_VERSION  = 6.54
MM_REVISION = 65400
...
MAKE = make
FULLEXT = Module/Install/ParseRequires
BASEEXT = ParseRequires
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/Module/Install/ParseRequires.pm
...
TO_INST_PM = lib/Module/Install/ParseRequires.pm

PM_TO_BLIB = lib/Module/Install/ParseRequires.pm \
	blib/lib/Module/Install/ParseRequires.pm
...
DISTVNAME = Module-Install-ParseRequires-0.001
...
manifypods : pure_all  \
	lib/Module/Install/ParseRequires.pm
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/Module/Install/ParseRequires.pm $(INST_MAN3DIR)/Module::Install::ParseRequires.$(MAN3EXT) 
...
ppd :
	...
	$(NOECHO) $(ECHO) '    <ABSTRACT>A Module::Install extension that provides an alternate way to specify dependencies</ABSTRACT>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <AUTHOR>Robert Krimen</AUTHOR>' >> $(DISTNAME).ppd
	...
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="Module::Install" VERSION="0.85" />' >> $(DISTNAME).ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  lib/Module/Install/ParseRequires.pm blib/lib/Module/Install/ParseRequires.pm 
